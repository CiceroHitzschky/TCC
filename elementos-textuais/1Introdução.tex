...
% Justificativa
    ...
    \enquote{
    	Pelo fim do século dezenove, a ênfase no rigor levou numerosos matemáticos à produção de exemplos de funções 'patológicas' que, devido a alguma propriedade incomum, violavam um teorema que antes se supunha válido em geral} \cite[p.415]{boy}.
