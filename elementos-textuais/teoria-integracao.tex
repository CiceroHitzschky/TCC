...
\begin{definition}
	...
	Diremos que alguma propriedade ocorre em para a medida $\mu$ em quase todo ponto, se existe um subconjunto $\mathcal{N} \subset \cc$ tal que $\mu(\mathcal{N}) = 0$ e a propriedade ocorra para $\mathcal{N}^c$.
