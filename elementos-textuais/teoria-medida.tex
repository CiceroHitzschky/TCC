...
\begin{prova}
	Suponha que $A \subset B$, então $B = A \cup (B - A)$ e $A \cap (B - A) = \varnothing$. Segue pela propriedade $(ii)$ da definição \ref{def:medida} que 
	$$\mu(B) = \mu(A) + \mu(B-A)$$
...
\begin{env}{Exemplo}[Medida de Conjuntos Discretos]
