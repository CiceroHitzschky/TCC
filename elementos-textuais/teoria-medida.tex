...
\end{example}
	...
	Uma truncamento faz, basicamente, uma espécie de limitação no gráfico da função original.
...
\begin{example}[Medida de Conjuntos Discretos]
